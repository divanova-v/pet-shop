 ...
 */
class Version20170422204244 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sale_offer ADD CONSTRAINT FK_F90ADFBD4584665A FOREIGN KEY (product_id) REFERENCES product (id) ON DELETE CASCADE');
